...
export class AgregarEstudianteComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.formEstudiante.nombresEstudiante = this.form.get('nombre')?.value;
    this.formEstudiante.apellidosEstudiante = this.form.get('apellido')?.value;
    this.formEstudiante.codigoEstudiante = this.form.get('codigo')?.value;
    this.formEstudiante.correoEstudiante = this.form.get('correo')?.value;
    // Mostrar dialogo
    Swal.fire({
